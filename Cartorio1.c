...
int main()
{
	int opcao=0; //um "=(igual)" quando é atribuição (Definindo variáveis)
	int laco=1;				//dois "==(iguais) quando é comparação
	...
	for(laco=1;laco=1;)
	{
		...
		system("cls"); //o sistema deleta todas as mensagens anteriores (tipo um transição de tela)
